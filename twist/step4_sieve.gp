...
sieve_prime(q, r) = {
  ...
  if (issquare(Mod(34, q)), my(s17 = sqrt(Mod(34, q))); foreach ([s17, -s17], s, my(Y = s * (xmq - xpq)^3, P1 = tob(ellchangepoint([Aq, Aq*Y], v1q), a1_1, a3_1), P2 = tob(ellchangepoint([Dq2, Dq2*Y], v2q), a1_2, a3_2)); npts++;
